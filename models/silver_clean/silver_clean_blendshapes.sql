...
AND blendshapes."_neutral" BETWEEN 0 AND 1
AND blendshapes.browDownLeft BETWEEN 0 AND 1
AND blendshapes.browDownRight BETWEEN 0 AND 1
AND blendshapes.browInnerUp BETWEEN 0 AND 1
AND blendshapes.browOuterUpLeft BETWEEN 0 AND 1
AND blendshapes.browOuterUpRight BETWEEN 0 AND 1
AND blendshapes.cheekPuff BETWEEN 0 AND 1
AND blendshapes.cheekSquintLeft BETWEEN 0 AND 1
AND blendshapes.cheekSquintRight BETWEEN 0 AND 1
AND blendshapes.eyeBlinkLeft BETWEEN 0 AND 1
AND blendshapes.eyeBlinkRight BETWEEN 0 AND 1
AND blendshapes.eyeLookDownLeft BETWEEN 0 AND 1
AND blendshapes.eyeLookDownRight BETWEEN 0 AND 1
AND blendshapes.eyeLookInLeft BETWEEN 0 AND 1
AND blendshapes.eyeLookInRight BETWEEN 0 AND 1
AND blendshapes.eyeLookOutLeft BETWEEN 0 AND 1
AND blendshapes.eyeLookOutRight BETWEEN 0 AND 1
AND blendshapes.eyeLookUpLeft BETWEEN 0 AND 1
AND blendshapes.eyeLookUpRight BETWEEN 0 AND 1
AND blendshapes.eyeSquintLeft BETWEEN 0 AND 1
AND blendshapes.eyeSquintRight BETWEEN 0 AND 1
AND blendshapes.eyeWideLeft BETWEEN 0 AND 1
AND blendshapes.eyeWideRight BETWEEN 0 AND 1
AND blendshapes.jawForward BETWEEN 0 AND 1
AND blendshapes.jawLeft BETWEEN 0 AND 1
AND blendshapes.jawOpen BETWEEN 0 AND 1
AND blendshapes.jawRight BETWEEN 0 AND 1
AND blendshapes.mouthClose BETWEEN 0 AND 1
AND blendshapes.mouthDimpleLeft BETWEEN 0 AND 1
AND blendshapes.mouthDimpleRight BETWEEN 0 AND 1
AND blendshapes.mouthFrownLeft BETWEEN 0 AND 1
AND blendshapes.mouthFrownRight BETWEEN 0 AND 1
AND blendshapes.mouthFunnel BETWEEN 0 AND 1
AND blendshapes.mouthLeft BETWEEN 0 AND 1
AND blendshapes.mouthLowerDownLeft BETWEEN 0 AND 1
AND blendshapes.mouthLowerDownRight BETWEEN 0 AND 1
AND blendshapes.mouthPressLeft BETWEEN 0 AND 1
AND blendshapes.mouthPressRight BETWEEN 0 AND 1
AND blendshapes.mouthPucker BETWEEN 0 AND 1
AND blendshapes.mouthRight BETWEEN 0 AND 1
AND blendshapes.mouthRollLower BETWEEN 0 AND 1
AND blendshapes.mouthRollUpper BETWEEN 0 AND 1
AND blendshapes.mouthShrugLower BETWEEN 0 AND 1
AND blendshapes.mouthShrugUpper BETWEEN 0 AND 1
AND blendshapes.mouthSmileLeft BETWEEN 0 AND 1
AND blendshapes.mouthSmileRight BETWEEN 0 AND 1
AND blendshapes.mouthStretchLeft BETWEEN 0 AND 1
AND blendshapes.mouthStretchRight BETWEEN 0 AND 1
AND blendshapes.mouthUpperUpLeft BETWEEN 0 AND 1
AND blendshapes.mouthUpperUpRight BETWEEN 0 AND 1
AND blendshapes.noseSneerLeft BETWEEN 0 AND 1
AND blendshapes.noseSneerRight BETWEEN 0 AND 1